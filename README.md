...
- Python 3.12 o superior (si ejecutas en local).
- pip y virtualenv (o venv).
- Docker y Docker Compose (opcional, para despliegue).
- Redis (opcional, si no usas Docker; en su defecto, la app usará   	caché en memoria).
...
**Importante:** Sustituye `tu-usuario` por tu nombre de usuario real en GitHub (o la URL que corresponda).

```bash


# Clonar (con tu URL real)
git clone https://github.com/fabianaldo2024-arch/acortador_url.git
